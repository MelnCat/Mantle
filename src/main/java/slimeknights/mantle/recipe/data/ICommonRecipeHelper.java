...
public interface ICommonRecipeHelper extends IRecipeHelper {
  ...
  default void woodCrafting(Consumer<FinishedRecipe> consumer, WoodBlockObject wood, String folder) {
    ...
    // planks
    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, wood, 4).requires(wood.getLogItemTag())
                          .group("planks")
    ...
    // log to stripped
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getWood(), 3)
                       .define('#', wood.getLog())
                       .pattern("##").pattern("##")
                       .group("bark")
                       .unlockedBy("has_log", RecipeProvider.has(wood.getLog()))
                       .save(consumer, location(folder + "log_to_wood"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getStrippedWood(), 3)
    ...
    // doors
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getFence(), 3)
                       .define('#', Tags.Items.RODS_WOODEN).define('W', wood)
                       .pattern("W#W").pattern("W#W")
                       .group("wooden_fence")
                       .unlockedBy("has_planks", hasPlanks)
                       .save(consumer, location(folder + "fence"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getFenceGate())
                       .define('#', Items.STICK).define('W', wood)
                       .pattern("#W#").pattern("#W#")
                       .group("wooden_fence_gate")
                       .unlockedBy("has_planks", hasPlanks)
                       .save(consumer, location(folder + "fence_gate"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getDoor(), 3)
                       .define('#', wood)
                       .pattern("##").pattern("##").pattern("##")
                       .group("wooden_door")
                       .unlockedBy("has_planks", hasPlanks)
                       .save(consumer, location(folder + "door"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getTrapdoor(), 2)
                       .define('#', wood)
                       .pattern("###").pattern("###")
    ...
    // buttons
    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, wood.getButton())
                          .requires(wood)
                          .group("wooden_button")
                          .unlockedBy("has_planks", hasPlanks)
                          .save(consumer, location(folder + "button"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getPressurePlate())
                       .define('#', wood)
                       .pattern("##")
    ...
    // signs
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, wood.getSign(), 3)
                       .group("sign")
