  ...
  public void drawOverlay(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
    if (this.isHovered(mouseX, mouseY) && this.currentItem < this.itemCycle.size()) {
      if (this.tooltip != null) {
        this.drawTooltip(guiGraphics, this.tooltip, mouseX, mouseY, mc.font);
      }
      else {
        this.renderToolTip(guiGraphics, mc.font, this.itemCycle.get(this.currentItem), mouseX, mouseY);
      }
    }
  }
